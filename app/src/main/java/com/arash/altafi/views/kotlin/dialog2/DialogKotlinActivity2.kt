    ...
    private fun init() {
        btn_dialog2_clicked_kotlin.setOnClickListener {
            val dialog = FancyDialogBuilder(this, R.style.CustomDialog)
                ...
                .withTitleTypeFace(R.font.helveticabold)
                .withSubTitleTypeFace(R.font.helvetica_regular)
                .withActionPositiveTypeFace(R.font.montserrat_bold)
                .withActionNegativeTypeFace(R.font.montserrat_regular)
