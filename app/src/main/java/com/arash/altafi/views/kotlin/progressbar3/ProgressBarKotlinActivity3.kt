package com.arash.altafi.views.kotlin.progressbar3
...
class ProgressBarKotlinActivity3 : AppCompatActivity() {

    private lateinit var containerLL: LinearLayout

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_progress_bar_kotlin3)
...
//        initLinearDotsLoader()
    ...
    private fun initCircularDotsLoader() {
        var cirLoader = CircularDotsLoader(this@ProgressBarKotlinActivity3)
